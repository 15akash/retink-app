...
function NavigationBar(props) {
  return (
    <nav className="flex bg-white filter drop-shadow-2xl shadow-lg">
      ...
      <div className="lg:w-1/3 lg:flex justify-evenly hidden px-15 mx-10  text-center items-center text-comet-500 text-sm">
      ...
      <div className="md:w-1/2 lg:w-1/3 flex justify-end px-20 my-2 py-2 ">
        <Link to={"/login"}>
          ...
          {props.isLoggedIn && (
            <button className="bg-blue-600 hover:bg-blue-800 text-white flex w-28 font-sans font-base text-base py-2 px-4 rounded shadow-xl ">
              Dashboard
            </button>
          )}
        </Link>
